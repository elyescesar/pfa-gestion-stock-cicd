...
\begin{itemize}
  ...
  \item \textbf{Prometheus} — rétention 2 jours, ressources limitées pour kind ;
  \item composants control-plane désactivés (scheduler, etcd, etc.) pour alléger le cluster de démo.
\end{itemize}
...
make grafana
# ou scripts/port-forward-grafana.sh
